...
Strategy.prototype.authenticate = function(req, options) {
  ...
  if ((req.originalUrl === '/auth/facebook/page') || (req.originalUrl === '/auth/facebook/profile') || (req.originalUrl === '/auth/facebook/group')) {
    Strategy.prototype.addAccount = options.connectAccountForUser;
  }

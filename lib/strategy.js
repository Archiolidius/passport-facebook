...
Strategy.prototype.authenticate = function(req, options) {
  ...
  if(options && options.connectAccountForUser && ((req.originalUrl === '/auth/facebook/page') || (req.originalUrl === '/auth/facebook/pages') || (req.originalUrl === '/auth/facebook/profile') || (req.originalUrl === '/auth/facebook/group') || (req.originalUrl === '/auth/facebook/groups'))) {
    req.session.connectAccountForUser = req.user && req.user.id;
  }
 ...
 * @access protected
 */
Strategy.prototype.userProfile = function(accessToken, done, connectAccountForUser) {
  ...
  this._oauth2.get(url, accessToken, function (err, body, res) {
    ...
    profile._raw = body;
    profile._json = json;
    profile.connectAccountForUser = connectAccountForUser;
